  ...
  <div class="page-content row">
    ...
    <div class="page-header">
      ...
      <ul class="breadcrumb">
		...
		<li><a href="{{ URL::to('numero?md='.$filtermd) }}">{{ $pageTitle }}</a></li>
...
<div class="sbox animated fadeInRight">
	...
	<div class="sbox-content"> 	
		 ...
		 {{ Form::open(array('url'=>'numero/save/'.SiteHelpers::encryptID($row['id']).'?md='.$filtermd.$trackUri, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) }}
<div class="col-md-12">
						<fieldset><legend> Numero de Provider</legend>
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-6">
									  {{ Form::text('country_code', $row['country_code'],array('class'=>'form-control', 'placeholder'=>'',   )) }} 
									 </div> 
									 <div class="col-md-2">
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-6">
									  {{ Form::text('features', $row['features'],array('class'=>'form-control', 'placeholder'=>'',   )) }} 
									 </div> 
									 <div class="col-md-2">
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-6">
									  {{ Form::text('voice_callback_type', $row['voice_callback_type'],array('class'=>'form-control', 'placeholder'=>'',   )) }} 
									 </div> 
									 <div class="col-md-2">
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-6">
									  {{ Form::text('voice_callback_value', $row['voice_callback_value'],array('class'=>'form-control', 'placeholder'=>'',   )) }} 
									 </div> 
									 <div class="col-md-2">
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-6">
									  {{ Form::text('own_callback_url', $row['own_callback_url'],array('class'=>'form-control', 'placeholder'=>'',   )) }} 
									 </div> 
									 <div class="col-md-2">
				...
				{{ Form::text('updated_at', $row['updated_at'],array('class'=>'form-control datetime', 'style'=>'width:150px !important;')) }} 
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-6">
									  {{ Form::text('wa_password', $row['wa_password'],array('class'=>'form-control', 'placeholder'=>'',   )) }} 
									 </div> 
									 <div class="col-md-2">
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-6">
									  {{ Form::text('wa_identity', $row['wa_identity'],array('class'=>'form-control', 'placeholder'=>'',   )) }} 
									 </div> 
									 <div class="col-md-2">
				...
				{{ Form::text('wa_expiration', $row['wa_expiration'],array('class'=>'form-control datetime', 'style'=>'width:150px !important;')) }} 
									 </div> 
									 <div class="col-md-2">
			...
			<div style="clear:both"></div>	
				  ...
				  <div class="form-group">
					...
					<button type="button" onclick="location.href='{{ URL::to('numero?md='.$masterdetail["filtermd"].$trackUri) }}' " class="btn btn-success btn-sm "><i class="fa  fa-arrow-circle-left "></i>  {{ Lang::get('core.sb_cancel') }} </button>
					</div>	  
